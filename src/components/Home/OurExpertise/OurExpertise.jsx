export const OurExpertise=()=>{
    return(
        <div id="block-expertise">
            <p id="block-name-expertise">Our expertise</p>
            <h1 className="color-white" id="title-of-expertise">
                "The best apartment in Dubai" we will find \n your dream
            </h1>
            <p className="color-white" id="text-of-expertise">
